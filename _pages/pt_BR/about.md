...
<table>
    ...
    <tr>
        <td>Portfolio artístico (<a href="{{ site.baseurl }}/assets/Tiago Brizolara - Portfolio Artistico - 05-01-2022.pdf">PDF</a> | <a href="https://docs.google.com/document/d/1Wmby-kPhGYv6Tq8ZW2w_QPkONiA9vbTCutrh810w4hE">Google Docs</a>)</td>
        <td>&nbsp;&nbsp;</td>
...
<h4 id="release">Release (artístico)</h4> <!-- TODO FIXME - the template was jumping to h3 (we should not jump h's), and I'm jumping even more, because of fonte size... -->
